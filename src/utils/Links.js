...
export default class Links {
  ...
  static getDriverDetailsRentIn =
    Links.API + 'staff/get_driver_details_rent_in';
  ...
  static generatePdf = Links.API + 'staff/generatePdf';
  static sendAuth = Links.API + 'staff/send_email_authorization';
