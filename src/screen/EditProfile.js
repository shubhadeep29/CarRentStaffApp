...
export default class MyProfile extends React.Component {
  ...
  callMyProfileApi = async () => {
    if (!this.state.fullName) {
      Toast.show('Name can not be empty', Toast.SHORT);
      return;
    }
    if (!this.state.role) {
      Toast.show('Role can not be empty', Toast.SHORT);
      return;
    }
    if (!this.state.email) {
    ...
    if (this.state.imageName !== 'No choosen file') {
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.rowView}>
                    <View style={styles.buttonContainer}>
                      <Text numberOfLines={1} style={styles.editTextStyle}>
                        Choose File
                      </Text>
                    </View>
