  ...
  constructor(props) {
    ...
    this.state = {
      ...
      menuList: [
        {
          title: 'Dashboard',
          image: require('../images/ic_dashboard.png'),
          flag: 'dashboard',
        },
        {
          title: 'My Profile',
          image: require('../images/ic_person.png'),
          flag: 'profile',
        },
        {
          title: 'Car Maintaince',
          image: require('../images/ic_car_setting.png'),
          flag: 'carMaintaince',
        },
        {
          title: 'Validate/Approve Driver',
          image: require('../images/ic_driver.png'),
          flag: 'approveDriver',
        },
        {
          title: 'Rent out Vehicle',
          image: require('../images/ic_car_key.png'),
          flag: 'rentOutVehicle',
        },
        {
          title: 'Return in Vehicle',
          image: require('../images/ic_car_return.png'),
        ...
        },
        {
          ...
          image: require('../images/ic_change_password.png'),
          flag: 'changePassword',
        },
        {
          title: 'Logout',
  ...
  renderRowItem = ({item, index}) => {
    ...
    return (
      <TouchableOpacity onPress={() => this.onMenuClick(screen)}>
        ...
        {this.state.menuList.length - 1 == index ? null : (
