    ...
    constructor(props) {
        ...
        this.state = {
            ...
            menuList: [
                ...
                { title: "Bond Return Entry", image: require("../images/ic_bond_return_entry.png"), flag: "bondReturnEntry" },
                { title: "Change Password", image: require("../images/ic_change_password.png"), flag: "changePassword" },
                { title: "Logout", image: require("../images/ic_logout.png"), flag: "logout" },
            ],
        }
    }
